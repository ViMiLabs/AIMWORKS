...
- Separated 36 schema subjects, 1840 controlled vocabulary subjects, and 1515 example or data-like subjects.
- Generated or normalized 5726 annotations and metadata updates for version 2026.3.0.
- Published 364 mapped review rows across the alignment outputs.
- Validation status is warning with SHACL conforms set to False.
