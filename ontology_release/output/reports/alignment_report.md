...
- `AST Dataset` -> `has metadata` [rejected_kind_mismatch]
- `AST Dataset` -> `obsolete data` [rejected_deprecated_target]
- `AST Dataset` -> `obsolete abstract data type` [rejected_deprecated_target]
