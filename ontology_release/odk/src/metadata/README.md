 ...
 * [h2kg.yml](h2kg.yml)
     * Determines how your purl.obolibrary.org/obo/h2kg/ redirects will be handled
     ...
     * Paste in the contents of [h2kg.yml](h2kg.yml)
 ...
 * [h2kg.md](h2kg.md)
     ...
     * Paste in the contents of [h2kg.md](h2kg.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
