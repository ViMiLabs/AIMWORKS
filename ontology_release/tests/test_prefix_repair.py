...
def test_repair_doc_prefixes_updates_reference_and_graph() -> None:
    with tempfile.TemporaryDirectory(prefix="prefix-repair-") as tmp_dir:
        docs_root = Path(tmp_dir) / "pemfc"
